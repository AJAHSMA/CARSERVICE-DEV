        ...
        this.each(function () {
            ...
            $.each($(easyTree).find('ul > li'), function() {
                ...
                if($(this).is('li:has(ul)')) {
                    ...
                    $(this).find(' > span > span').addClass('glyphicon-chevron-down1');
                    ...
                    if($(this).is('li:has(>a)')){
                        // var a = $(this).html();
                        var startingTag = $($(this).html())[0].outerHTML.split($($(this).html()).html())[0];
                    }
                    if(startingTag != null){
                        $(this).html('<span><span class="glyphicon"></span>'+startingTag+'</a> </span>');
                    }else{
                        $(this).html('<span><span class="glyphicon"></span><a href="javascript: void(0);"></a> </span>');
                    }
            ...
            //                 } else {
            //                     $(selected).addClass('parent_li').find(' > span > span').addClass('glyphicon-chevron-down1').removeClass('glyphicon-file');
            ...
            //                     $(selected).parents('li').removeClass('parent_li').find(' > span > span').removeClass('glyphicon-chevron-down1').addClass('glyphicon-file');
            ...
            $(easyTree).delegate('li.parent_li > span', 'click', function (e) {
                ...
                if (children.is(':visible')) {
                    ...
                    $(this).attr('title', options.i18n.expandTip)
                        .find(' > span.glyphicon')
                        .addClass('glyphicon-chevron-right1')
                        .removeClass('glyphicon-chevron-down1');
                } else {
                    children.show('fast');
                    $(this).attr('title', options.i18n.collapseTip)
                        .find(' > span.glyphicon')
                        .addClass('glyphicon-chevron-down1')
                        .removeClass('glyphicon-chevron-right1');
                }
                e.stopPropagation();
            });
